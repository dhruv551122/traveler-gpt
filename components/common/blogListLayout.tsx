...
const BlogListLayout = ({ blogs, title }: { blogs: NonNullable<HomePageQueryResult>['blogs'], title?: string }) => {
    return (
        <div className="max-content-pannel max-width-container">
            <h2 className="subtitle">{title}</h2>
            <div className="gris grid-cols-3 gap-4">
                <div className="flex flex-col gap-4">
                    <SanityImage src={blogs[0].heroImage} width={1000} height={1000} className="w-full grow h-auto object-cover" />
